...
class QuizRouter implements Router<Hono> {
  constructor(
  ...
  getRouter() {
    ...
    quiz.get("/", async (c) => {
      const quizzes = await this.quizController.getAll();
      ...
      .post(
        ...
        async (c) => {
          ...
          const quiz = await this.quizController.create({
            name: body.name,
    ...
    quiz.get(
      ...
      async (c) => {
        ...
        const quiz = await this.quizController.getById(quizId);
    ...
    quiz.post(
      ...
      async (c) => {
        ...
        const question = await this.questionController.create({
          title: body.title,
          quiz_id: quizId,
          image: body.image,
        });
